...
<space><space>A. Launch directly from the GitHub repository
<space><space><space><space>+ Navigate to the GitHub repository page.
<space><space><space><space>+ Click the Launch Binder badge (or use this ?????Binder link?????).
